...
insert into gapp_application_status(statusid,comments,name) values(1,'the application is submitted by the student.','New(Submitted) '); 
insert into gapp_application_status(statusid,comments,name) values(2,'the application is saved by the student','Not Submitted');
...
insert into gapp_applications(appid,CIN,DOB,Date,GRE,TOEFL,applicantemail,applicantfirstname,applicantlastname,citizenship,gender,phone,term,id_id,prgmid_prgmid,statusid_statusid ) values(1,'','02-26-1991','03-07-2016 00:00:00','','','Harry@gmail.com','Harry','Shah','Indian','Male','999 999 9999','Spring 2017,',4,2,2)
