...
<body>
	...
	<div class="container">
		...
		<div class="well">
			...
			&nbsp&nbsp&nbsp&nbsp&nbsp<a href="student.html?id=${GappUsers.id }"
				class="btn btn-success">Back to Home Page</a> <br> <br>
			...
			<form:form modelAttribute="GappApplication1"
				action="createapplication.html" enctype="multipart/form-data"
				method="post">

Enter First Name: <form:input path="applicantfirstname" />
				<br>
Enter Last Name: <form:input path="applicantlastname" />
				<br>
Enter Email: <form:input path="applicantemail" />
				<br>
Enter Phone Number: <form:input path="phone" />
				<br>
Enter Gender: <form:input path="gender" />
				<br>
Enter DOB: <form:input path="DOB" />
				<br>
...
<div id="inputs">
					...
					Degree Earned : <input type='text' name='degreeearn'> Major
					: <input type='text' name='major'> GPA : <input type='text'
						name='gpa'> <a href="#" class="btn btn-info"
						onclick="getinput()">Add More Degree</a><br>
				</div>
