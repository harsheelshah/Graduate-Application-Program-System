...
<body>
	<div class="container">
		...
		<div class="well">
			...
			<br>
			<h3>
				<b>Application Personal Information</b>
			</h3>
			<table border=2>
				<tr>
					<td><h4>
			...
			<c:choose>
				<c:when test="${empty GappApplication.transcript.filename}">
					<h3>
						<b>Download Transcript</b>
					</h3>
				</c:when>
				<c:otherwise>
					<h3>
						<b>Download Transcript of Latest University Attended:</b>
					</h3>

					<a class="btn btn-success"
						href="../download.html?filename=${GappApplication.transcript.filename }">Download
						Transcript</a>
				</c:otherwise>
			</c:choose>
		</div>
