...
public class StudentController {
	...
	public String EditDept(@ModelAttribute GappDepartment d,
	...
	public String AddPrgmDept(@ModelAttribute GappProgram p,
			BindingResult result, @RequestParam Integer deptid) {

		List<GappDepartment> d = new ArrayList<GappDepartment>();
		GappDepartment d1 = deptDao.getDepartmentId(deptid);
		/*
		 * System.out.println(d1); System.out.println(p);
		 */
		// d.add(d1);
		p.setDeptid(d1);
	...
	public String AddAdditionalDept(@RequestParam Integer deptid,
			ModelMap models) {
	...
	public String AddAdditionalDept(@ModelAttribute GappAdditional a,
			BindingResult result, @RequestParam Integer deptid,
	...
	public String RemovePrgm(@RequestParam Integer prgmid) {
		 ...
		 * GappApplication a1 = new GappApplication(); a1.setPrgmid(null);
		 * a.add(a1); a = appDao.saveApplicationList(a);
		 */
	...
	public String ad(@RequestParam Integer additionalid, ModelMap models) {
		// GappProgram p1 = prgmDao.getProgramId(prgmid);
		models.put("GappAdditional",
				additionalDao.getAdditionalId(additionalid));
		return "student/ad";
	}
	...
	public String AddPrgm(@ModelAttribute GappProgram p, BindingResult result,
			@RequestParam Integer deptid) {

		List<GappDepartment> d = new ArrayList<GappDepartment>();
		GappDepartment d1 = deptDao.getDepartmentId(deptid);
		/*
		 * System.out.println(d1); System.out.println(p); d.add(d1);
		 */
		p.setDeptid(d1);
	...
	public String AddAdditional(@ModelAttribute GappAdditional p,
			BindingResult result, @RequestParam Integer deptid,
			@RequestParam String type) {
	...
	public String Admin(ModelMap models) {
		 ...
		 * if(p.getDeptid().getDeptid()==d.getDeptid()) models.put( "did",
		 * d.getDeptid() );
		 */
	...
	public String Register(@ModelAttribute GappUsers GappUsers,
		 ...
		 * if(users1.size()>0) { System.out.println("Error"); } else{
		 */
		g1.setTypeid(3);
		g.add(g1);
	...
	public String ViewApplication(@RequestParam Integer id,
			@RequestParam Integer deptid, @RequestParam Integer prgmid,
			@RequestParam Integer appid, ModelMap models) {
	...
	public String EditApplication(@RequestParam Integer id,
			@RequestParam Integer deptid, @RequestParam Integer prgmid,
			@RequestParam Integer appid, ModelMap models) {
	...
	public String EditApplication(
			@ModelAttribute GappApplication GappApplication1,
			BindingResult bindingResult,
			@RequestParam MultipartFile transcript, HttpServletRequest request,
			@RequestParam Integer appid, @RequestParam Integer user1,
			@RequestParam Integer dept, @RequestParam Integer prgm,
			@RequestParam String term, @RequestParam Integer fileid,
			@RequestParam String[] colname, @RequestParam String[] timeattend,
			@RequestParam String[] degreeearn, @RequestParam String[] major,
			@RequestParam String[] gpa) throws IllegalStateException,
			IOException {
		...
		if (save != null) {
			...
			if (transcript.getOriginalFilename().isEmpty()) {
				...
				transcript.transferTo(new File(getFileDirectory(), a
	...
	public List<GappProgram> ListGappPrograms(
	...
	public String CreateApplication(
			...
			BindingResult bindingResult,
			@RequestParam MultipartFile transcript, HttpServletRequest request,
			@RequestParam String term, @RequestParam Integer user,
			@RequestParam Integer dept, @RequestParam String[] colname,
			@RequestParam String[] timeattend,
			@RequestParam String[] degreeearn, @RequestParam String[] major,
			@RequestParam String[] gpa) throws IllegalStateException,
			IOException {
	...
	public String RemoveEducation(@RequestParam Integer arid,
			@RequestParam Integer prgmid, @RequestParam Integer deptid,
			@RequestParam Integer id, @RequestParam Integer appid) {

		GappAcademicRecords ar1 = usersDao.getGappAcademicRecordsId(arid);

		usersDao.remove(ar1);

		return "redirect:editapplication.html?prgmid=" + prgmid + "&&deptid="
				+ deptid + "&&appid=" + appid + "&&id=" + id;

	}

	@RequestMapping(value = "/student/getProg.html", method = RequestMethod.GET)
	public @ResponseBody String getPrograms(HttpServletRequest request,
			HttpServletResponse response, ModelMap models) {

		String json = null;
		List<String> addprgm = new ArrayList<String>();

		Integer department = Integer.parseInt(request
